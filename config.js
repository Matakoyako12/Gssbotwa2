...
global.ownername = "Ray thee bandit";
global.owner = ['254791195553'];
global.premium = ['917050906659'];
global.packname = "𝚜𝚝𝚒𝚌𝚔𝚎𝚛 𝚋𝚢";
global.author = "Ray thee-bandit";
...
global.mess = {
    ...
    success: '`✓ Success`',
    admin: '`ask your father maybe cuz i dont see you crowned`',
    botAdmin: '`I am not an admin!`',
    owner: '`better ask ray`',
